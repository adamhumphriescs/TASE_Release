...
//Extra TASE includes and defs are below.
#include <stdlib.h>
#include <stdbool.h>
#include "intprops.h"
#include <errno.h>
...
#include <string.h>                                                                                                                                                                                   //From fnmatch.c
# define STREQ(s1, s2) (strcmp (s1, s2) == 0)

//Should not need to distinguish between Text and binary IO in linux,
...
#define die(status, ... ) \
  { printf("Died in cksum with error code %d \n", status); exit(-1); }
...
//Usage and main fns were stripped out for TASE Eval.
