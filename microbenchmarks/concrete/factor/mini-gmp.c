...
//We don't need doubles for the factorization benchmark in the TASE
//paper.  TASE doesn't currently support double arithmetic now anyway,
//so we remove the code that uses doubles below.
#if 0
void
