...
/* Define to 1 if you have the GMP library instead of just the mini-gmp
   replacement. */
#define HAVE_GMP 1
...
#define PACKAGE_STRING "GNU coreutils 8.32.45-49bd0"
...
#define PACKAGE_VERSION "8.32.45-49bd0"
