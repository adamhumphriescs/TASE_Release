...
$TASE_CLANG -I"." -I$TASE_DIR/include/tase/ -c -O1 -DTASE_TEST $NO_FLOAT_ARG $MODELED_FN_ARG  harness.c make_byte_symbolic.c tsort.c readtokens.c xalloc-die.c xmalloc.c
