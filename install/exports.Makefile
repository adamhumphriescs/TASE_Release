...
export MODELED_FN_ARG_NOTSX=-mllvm -x86-tase-modeled-functions=$(INCLUDE_DIR)/tase/core_modeled.h -mllvm -x86-tase-instrumentation-mode=naive
export MODELED_FN_ARG=-mllvm -x86-tase-modeled-functions=$(INCLUDE_DIR)/tase/core_modeled.h -mllvm -x86-tase-instrumentation-mode=simd
...
export KLEE_LINK_LIBS=$(addprefix $(RUN_DIR)/lib/,$(addprefix lib,$(addsuffix .a,$(KLEE_LIBS))) $(LIBTASE) libminisat.a libstp.a)
