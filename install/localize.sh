...
do
    objcopy --localize-symbol=$LIB $OBJ
done
...
objcopy --redefine-syms=/TASE_BUILD/test/scripts/redefinedSF $OBJ
objcopy --redefine-syms=/TASE_BUILD/test/scripts/redefinedStrConv $OBJ
