...
$TASE_CLANG -I"." -I$TASE_DIR/include/tase/ -c -O1 -DTASE_TEST $NO_FLOAT_ARG $MODELED_FN_ARG  bigNum.c 
cp bigNum.o ./tmp/


#Tase mem function traps, e.g. malloc_tase, free_tase
$TASE_CLANG -c -O0 $NO_FLOAT_ARG $MODELED_FN_ARG $TASE_DIR/traps/tase_shims.c -o ./tmp/tase_shims.o
...
#LIBTASE-------------------------------------------
$TASE_CLANG -fPIC -c -O1 -DTASE_TSX -DTASE_ENABLE=1 -I$TASE_DIR/include  $MODELED_FN_ARG $TASE_DIR/springboard.S -o $TASE_DIR/springboard.o
$TASE_ROOT_DIR/install_root/llvm-3.4.2/bin/clang -fPIE -c -O1 -I$TASE_DIR/include $TASE_DIR/log.c -o $TASE_DIR/log.o
$TASE_ROOT_DIR/install_root/llvm-3.4.2/bin/clang -fPIE -c -O1 -I$TASE_DIR/include $TASE_DIR/common.c -o $TASE_DIR/common.o

$TASE_CLANG -fPIE -c -O1 -DTASE_TSX -DTASE_ENABLE=1 -I$TASE_DIR/include  $MODELED_FN_ARG $TASE_DIR/modeled/exit_tase.c -o $TASE_DIR/modeled/exit_tase.o
