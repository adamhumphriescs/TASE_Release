...
/opt/llvm-3.4.2/bin/clang -fPIE -c -O1 -I$TASE_DIR/include $TASE_DIR/log.c -o $TASE_DIR/log.o
/opt/llvm-3.4.2/bin/clang -fPIE -c -O1 -I$TASE_DIR/include $TASE_DIR/common.c -o $TASE_DIR/common.o
