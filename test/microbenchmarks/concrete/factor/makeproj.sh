...
$TASE_CLANG -DNO_ASM -I"." -I$TASE_DIR/include/tase/ -c -O1 -DTASE_TEST $NO_FLOAT_ARG $MODELED_FN_ARG harness.c  make_byte_symbolic.c factor.c readtokens.c xalloc-die.c xmalloc.c mini-gmp.c 
...
$TASE_CLANG -c -O1 -mllvm -x86-tase-modeled-functions=$TASE_DIR/include/tase/core_modeled.h $TASE_DIR/traps/mem_traps.c -o ./tmp/mem_traps.o
